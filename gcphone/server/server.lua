...
--  Contacts
--====================================================================================
function getContacts(identifier, source)
    local civId = TriggerEvent('gec:getCurrentCivId', source)
    local result = MySQL.Sync.fetchAll("SELECT * FROM phone_users_contacts WHERE phone_users_contacts.identifier = @identifier and civId = @civId", {
        ['@identifier'] = identifier,
        ['@civId'] = civId
    })
    return result
...
function addContact(source, identifier, number, display)
    ...
    local civId = TriggerEvent('gec:getCurrentCivId', sourcePlayer)
    MySQL.Async.insert("INSERT INTO phone_users_contacts (`identifier`, `number`,`display`, `civId`) VALUES(@identifier, @number, @display, @civId)", {
        ['@identifier'] = identifier,
        ['@number'] = number,
        ['@display'] = display,
        ['@civId'] = civId,
...
function deleteContact(source, identifier, id)
    local sourcePlayer = tonumber(source)
    local civId = TriggerEvent('gec:getCurrentCivId', sourcePlayer)
    MySQL.Sync.execute("DELETE FROM phone_users_contacts WHERE `identifier` = @identifier AND `id` = @id and `civId` = @civId", {
        ['@identifier'] = identifier,
        ['@id'] = id,
        ['@civId'] = civId,
    })
...
function deleteAllContact(identifier, sourcePlayer)
    local civId = TriggerEvent('gec:getCurrentCivId', sourcePlayer)
    MySQL.Sync.execute("DELETE FROM phone_users_contacts WHERE `identifier` = @identifier and `civId` = @civId", {
        ['@identifier'] = identifier,
        ['@civId'] = civId
    })
end
function notifyContactChange(source, identifier)
    ...
    if sourcePlayer ~= nil then
        TriggerClientEvent("gcPhone:contactList", sourcePlayer, getContacts(identifier, sourcePlayer))
    end
end
...
AddEventHandler('gcPhone:deleteALL', function()
    ...
    local identifier = getPlayerID(source)
    deleteAllMessage(identifier)
    deleteAllContact(identifier, sourcePlayer)
...
--  OnLoad
--====================================================================================
RegisterNetEvent('gcPhone:LoadPhone')
AddEventHandler('gcPhone:LoadPhone',function()
  local src = source
